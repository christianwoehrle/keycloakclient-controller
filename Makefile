...
# org/keycloakclient-controller-bundle:$VERSION and org/keycloakclient-controller-catalog:$VERSION.
IMAGE_TAG_BASE ?= org/keycloakclient-controller
...
IMG ?= dwpbank/keycloakclient-controller:exploratory2
